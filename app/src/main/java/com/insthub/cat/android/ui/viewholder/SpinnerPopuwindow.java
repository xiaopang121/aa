...
import com.insthub.cat.android.ui.adatper.SpinnerPopAdapter;
...
public class SpinnerPopuwindow extends PopupWindow {
    ...
    public SpinnerPopuwindow(final Activity context, final String string, final List<String> list,BaseRecyclerAdapter.OnItemClickListener itemsOnClick) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.context =context;
        conentView = inflater.inflate(R.layout.common_popupwindow, null);
        ...
        listView = (RecyclerView) conentView.findViewById(R.id.listView);
