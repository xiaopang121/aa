...
public class BidMustActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View, UploadImageAdapter.Callback {
    ...
    protected int getLayoutResId() {
        return R.layout.activity_bid_must;
    }
    ...
    protected void bindViewById() {
        super.bindViewById();
        mBidPriceDetialData = (BidPriceDetialData)getIntent().getExtras().getSerializable(ConstantsKeys.KEY_DATA);
        ...
        tvSure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mPresenter.competeTender(CacheManager.getInstance().getToken().getData().getUser_id(),
                        ...
                        mBidPriceDetialData.getData().getTender_id(),
                ...
                .setShareboardclickCallback(new ShareBoardlistener() {
                    ...
                    public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
                        ...
                        if (snsPlatform.mShowWord.equals("复制链接")) {
                            ...
                            // 将文本内容放到系统剪贴板里。
                            cm.setText(mBidPriceDetialData.getData().getShare().getShare_image());
                            ToastUtil.show(getActivity(),"复制链接成功");

                        }else
                        {
                            UMWeb web = new UMWeb(mBidPriceDetialData.getData().getShare().getShare_url());
                            web.setTitle(mBidPriceDetialData.getData().getShare().getShare_title());
                            web.setDescription(mBidPriceDetialData.getData().getShare().getShare_desc());
                            web.setThumb(new UMImage(getActivity(),mBidPriceDetialData.getData().getShare().getShare_image()));
