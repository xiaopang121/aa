...
public class KanjiaDetialActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View, LocalImgAdapter.BannerCallback {
    ...
    private CutdownDetialData mStoreDetialData;
    ...
    protected int getLayoutResId() {
        return R.layout.activity_kanjia_detial;
    }
...
//        mLBanners.setHoriZontalCustomTransformer(new ParallaxTransformer(R.id.id_image));//自定义样式
    ...
    private void updateView() {
        ...
        if (mStoreDetialData != null) {
            ...
            tvCanSize.setText(mStoreDetialData.getData().getActivity().getOrder_count()+"人已经成功砍价");
    ...
    protected void bindEvent() {
        ...
        tvBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mStoreDetialData==null)
                {
                    ToastUtil.show(getActivity(),"暂无信息");
                    return ;
                }

                Bundle bundle = new Bundle();
                bundle.putSerializable(ConstantsKeys.KEY_DATA,mStoreDetialData);
                startActivity(KanjiaTodoActivity.class,bundle);
        ...
        tvShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mStoreDetialData==null)
                {
                    ToastUtil.show(getContext(),"分享失败，数据异常");
                    return;
                }


                mShareListener = new CustomShareListener(KanjiaDetialActivity.this);
    ...
    protected void bindData() {
        ...
        mPresenter.getCutdownDetail(String.valueOf(data.getActivity_id()));
    ...
    public void showSuccess(Object object) {
        ...
        dismissLoadDialog();
        if (object instanceof CutdownDetialData) {
            mStoreDetialData = (CutdownDetialData) object;
            updateView();
...
//                             .into(ivCommentHead);
    ...
    private static class CustomShareListener implements UMShareListener {
        ...
        private WeakReference<KanjiaDetialActivity> mActivity;

        private CustomShareListener(KanjiaDetialActivity activity) {
