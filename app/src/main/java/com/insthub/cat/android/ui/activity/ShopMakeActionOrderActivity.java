...
public class ShopMakeActionOrderActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    protected int getLayoutResId() {
        return R.layout.activity_action_makeorder;
    }
        ...
        tvPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mPresenter.createOrder(CacheManager.getInstance().getToken().getData().getUser_id(),
                        ...
                        serviceName, price,time,market,dataBean.getStore_id());
    ...
    protected void bindData() {
        ...
        tvTotalMoney.setText("￥"+dataBean.getPrice());
        tvPayMoney.setText("￥"+dataBean.getPrice());
        ...
        tvPay.setText("确认支付：￥"+dataBean.getPrice());
    }
    ...
    private void  requestAlipay(String orderId){
        ...
        Map<String, String> params = OrderInfoUtil2_0.buildOrderParamMap(Constants.APPID,rsa2,dataBean.getPrice(),"订单支付",orderId,Constants.NOTIFY_URL,subject);
    ...
    private String getProductArgs(String orderId) {
        ...
        try {
            ...
            int money =(int)(dataBean.getPrice()*100);
