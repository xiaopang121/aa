...
public class MiaoshaMakeOrderActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    @Bind(R.id.tv_pay)
    TextView tvPay;
    private MiaoshaDetialData dataBean;
    ...
    protected void bindEvent() {
        ...
        tvPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                float  price = dataBean.getData().getActivity().getDiscount_price();
                ...
                mPresenter.createOrder(CacheManager.getInstance().getToken().getData().getUser_id(),
                        ...
                        dataBean.getData().getService_content(), price,dataBean.getData().getActivity().getBegin_time(),tvMarket.getText().toString(),dataBean.getData().getStore_id());
    ...
    protected void bindData() {
        ...
        dataBean = (MiaoshaDetialData) getIntent().getExtras().getSerializable(ConstantsKeys.KEY_DATA);

        tvShopname.setText(dataBean.getData().getStore_name());
        tvService.setText(dataBean.getData().getService_content());
        tvTotalMoney.setText("￥"+dataBean.getData().getActivity().getDiscount_price());
        tvPay.setText("确认支付：￥"+dataBean.getData().getActivity().getDiscount_price());
    ...
    private void  requestAlipay(String orderId){
        ...
        Map<String, String> params = OrderInfoUtil2_0.buildOrderParamMap(Constants.APPID,rsa2,dataBean.getData().getActivity().getDiscount_price(),"订单支付",orderId,Constants.NOTIFY_URL,subject);
