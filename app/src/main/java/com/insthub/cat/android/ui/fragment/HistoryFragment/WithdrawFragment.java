...
import com.insthub.cat.android.ui.adatper.WithdrawAdapter;
...
public class WithdrawFragment extends BaseFragment<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    private ArrayList<WithdrawListData.DataBean> dataList = new ArrayList<>();

    private WithdrawAdapter mTickListAdapter;

    private int type = -1;

    public static WithdrawFragment newInstance(int type) {
        WithdrawFragment mainFragment = new WithdrawFragment();
    ...
    protected void bindViewById() {
        ...
        mTickListAdapter = new WithdrawAdapter (getActivity(), dataList);
    ...
    protected void bindData() {
        ...
        dataList.clear();
        dataList.add(new WithdrawListData.DataBean());
        dataList.add(new WithdrawListData.DataBean());
