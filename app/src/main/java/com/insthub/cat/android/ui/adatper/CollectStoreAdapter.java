...
public class CollectStoreAdapter extends BaseRecyclerAdapter<CollectItemHolder, CollectListData.DataBean.StoreListBean> {


    public CollectStoreAdapter(Context context, List<CollectListData.DataBean.StoreListBean> list, boolean select) {
...
//        }
        ...
        CollectListData.DataBean.StoreListBean dataItem = getDataItem(position);
