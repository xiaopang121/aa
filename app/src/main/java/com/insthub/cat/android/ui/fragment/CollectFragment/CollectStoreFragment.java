...
public class CollectStoreFragment extends BaseFragment<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    private ArrayList<CollectListData.DataBean.StoreListBean> dataList = new ArrayList<>();

    private CollectStoreAdapter mTaitouAdapter;
    ...
    public static CollectStoreFragment newInstance() {
        CollectStoreFragment mainFragment = new CollectStoreFragment();
        return mainFragment;
    }
    ...
    protected void bindViewById() {
        ...
        mTaitouAdapter = new CollectStoreAdapter(getActivity(), dataList, true);
...
//                rightswipeMenu1.addMenuItem(addItem); // 添加菜单到右侧。
    ...
    public void showSuccess(Object object) {
        ...
        if (object instanceof CollectListData) {
            ...
            dataList.clear();
            dataList.addAll(data.getData().getStore_list());
