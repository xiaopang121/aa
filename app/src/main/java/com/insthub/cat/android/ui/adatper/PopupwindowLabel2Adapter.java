...
public class PopupwindowLabel2Adapter extends BaseRecyclerAdapter<PopupItemHolder, LabelListData.DataBean.LabelLv1Bean.LabelLv2Bean> {




    public PopupwindowLabel2Adapter(Context context, List<LabelListData.DataBean.LabelLv1Bean.LabelLv2Bean> list) {
