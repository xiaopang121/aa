...
public class InnovateMustActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View, UploadImageAdapter.Callback {
    ...
    private ZhengjiDetialData mZhengjiDetialData;
    ...
    protected int getLayoutResId() {
        return R.layout.activity_innovate_must;
    }
    ...
    protected void bindViewById() {
        super.bindViewById();
        mZhengjiDetialData = (ZhengjiDetialData)getIntent().getExtras().getSerializable(ConstantsKeys.KEY_DATA);
...
//                }
                ...
                mPresenter.competeTender(CacheManager.getInstance().getToken().getData().getUser_id(),
                        ...
                        mZhengjiDetialData.getData().getTender_id(),
                ...
                .setShareboardclickCallback(new ShareBoardlistener() {
                    ...
                    public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
                        ...
                        if (snsPlatform.mShowWord.equals("复制链接")) {
                            ...
                            // 将文本内容放到系统剪贴板里。
                            cm.setText(mZhengjiDetialData.getData().getShare().getShare_image());
                            ToastUtil.show(getActivity(),"复制链接成功");

                        }else
                        {
                            UMWeb web = new UMWeb(mZhengjiDetialData.getData().getShare().getShare_url());
                            web.setTitle(mZhengjiDetialData.getData().getShare().getShare_title());
                            web.setDescription(mZhengjiDetialData.getData().getShare().getShare_desc());
                            web.setThumb(new UMImage(getActivity(),mZhengjiDetialData.getData().getShare().getShare_image()));
