...
import com.insthub.cat.android.utils.DeviceUtils;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        underLine.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpTpPx(getResources().getDimension(R.dimen.view_margin_1))));
