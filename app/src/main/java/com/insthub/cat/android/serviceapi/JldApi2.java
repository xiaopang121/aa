...
public class JldApi2 extends BaseApi<JldApiService> {

    @Override
    protected String configServerHttpUrl() {
        return Constants.SERVICE_URL_PREFEX2;
    }
    ...
    public static JldApi2 _BaseApi;

    public static Object lock = new Object();

    public static JldApi2 getInstance()
    {
        synchronized (lock)
        {
            if(_BaseApi==null)
            {
                _BaseApi = new JldApi2();
            }
        }
        return _BaseApi;
    }
