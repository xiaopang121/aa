...
public class GestureLockDisplayViews extends RelativeLayout {
    ...
    private int mNoSelectStrokeWidth = 1;
    private int mSelectedStrokeWidth = 1;
    /**
     * 宽度
     */
    private int mWidth;
    ...
    private void reset() {
        for (GestureLockDisplayView GestureLockDisplayView : mGestureLockDisplayViews) {
            GestureLockDisplayView.setDisplayMode(com.insthub.cat.android.ui.widget.GestureLockDisplayView.DisplayMode.STATUS_NO_SELECT);
        }
    }
