...
public class ActionFragment3 extends BaseFragment<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    @Bind(R.id.tv_goods_now_price)
    EditText tvGoodsNowPrice;
    ...
    public static ActionFragment3 newInstance() {
        ActionFragment3 mainFragment = new ActionFragment3();
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_action3;
    }
    ...
    protected void bindEvent() {
        ...
        btSumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(tvGoodsNowPrice.getText().toString()))
                {
                    ToastUtil.show(getActivity(),"请输入商品现价");
                    return ;
                }
                ...
                {
                    ToastUtil.show(getActivity(),"请输入优惠数量");
                    return ;
                }
                ...
                mPresenter.createActivity(CacheManager.getInstance().getToken().getData().getUser_id(),
                        ...
                        tvGoodsNowPrice.getText().toString(),
                        tvStartTime.getText().toString(),
                        tvEndTime.getText().toString(),
                        "",
                        "",tvExtra.getText().toString(), tvNumber.getText().toString(),"","");
