...
import com.insthub.cat.android.helper.JavaScriptMethods;
...
public class HomeButtomActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    protected void bindViewById() {
        ...
        webSettings.setAllowFileAccess(true);  //设置可  以访问文件
        ...
        webview.addJavascriptInterface(new JavaScriptMethods(this), "daihao");
    ...
    protected void bindEvent() {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                {
                    commonTitleBar.setTitle(view.getTitle());
                }
                ...
                if(!isInit)
                {
                    try {
                        ...
                        webview.loadUrl("javascript:getLoginContent("+json.toString()+")");
                ...
                if (url != null && url.contains("static/toShare")) {
                    showShare();
    ...
    protected void bindData() {
        super.bindData();
        url = this.getIntent().getExtras().getString(ConstantsKeys.KEY_DATA);
        commonTitleBar.setTitle("数据加载中");
        ...
        ShareAction mShareAction = new ShareAction(getActivity()).setDisplayList(
                ...
                .setShareboardclickCallback(new ShareBoardlistener() {
                    ...
                    public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
                        ...
                        UMImage web = new UMImage(getActivity(),CacheManager.getInstance().getToken().getData().getShare_image());
...
//                        web.setDescription(mStoreDetialData.getData().getShare().getShare_desc());
                        web.setThumb(new UMImage(getActivity(),CacheManager.getInstance().getToken().getData().getShare_image()));
