...
public class ActionFragment2 extends BaseFragment<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    public static ActionFragment2 newInstance() {
        ActionFragment2 mainFragment = new ActionFragment2();
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_action2;
    }
