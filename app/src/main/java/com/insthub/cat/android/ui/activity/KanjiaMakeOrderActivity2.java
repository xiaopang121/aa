...
public class KanjiaMakeOrderActivity2 extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    @Bind(R.id.tv_pay)
    TextView tvPay;
    private KanjiaInfoData dataBean;
    ...
    protected void bindEvent() {
        ...
        tvPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                float price = dataBean.getData().getOld_price()-dataBean.getData().getCutdown_price();
                ...
                mPresenter.createOrder(CacheManager.getInstance().getToken().getData().getUser_id(),
                        ...
                        price,dataBean.getData().getCreate_time(),
    ...
    protected void bindData() {
        ...
        dataBean = (KanjiaInfoData) getIntent().getExtras().getSerializable(ConstantsKeys.KEY_DATA);

        tvShopname.setText(dataBean.getData().getStore_name());
        tvService.setText(dataBean.getData().getService_content());

        float currentPrice = dataBean.getData().getOld_price()-dataBean.getData().getCutdown_price();
    ...
    private String getProductArgs(String orderId) {
        ...
        try {
            ...
            int money =(int)(dataBean.getData().getDiscount_price()*100);
