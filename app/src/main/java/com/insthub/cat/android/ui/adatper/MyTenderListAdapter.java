...
public class MyTenderListAdapter extends BaseRecyclerAdapter<MyPublishItemHolder, TenderListData.DataBean.ListBean> {
    ...
    public MyTenderListAdapter(Context context, List<TenderListData.DataBean.ListBean> list) {
    ...
    public void onBindViewHolder(MyPublishItemHolder holder, int position) {
        ...
        TenderListData.DataBean.ListBean dataItem = getDataItem(position);
        holder.ivPublishType.setText("招");
        holder.ivPublishType.setBackgroundResource(R.drawable.ic_type_zhaobiao);
