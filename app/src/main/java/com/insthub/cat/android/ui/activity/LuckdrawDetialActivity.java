...
public class LuckdrawDetialActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View, LocalImgAdapter.BannerCallback {
    ...
    @Bind(R.id.tv_luckdraw_rule)
    TextView tvLuckyDrawRule;
    ...
    private ChoujiangDetialData mStoreDetialData;
    ...
    protected int getLayoutResId() {
        return R.layout.activity_luckdraw_detial;
    }
...
//        mLBanners.setHoriZontalCustomTransformer(new ParallaxTransformer(R.id.id_image));//自定义样式
    ...
    private void updateView() {
        ...
        if (mStoreDetialData != null) {
            ...
            tvBuyPrice.setText("¥" + mStoreDetialData.getData().getActivity().getMoney());


            tvCouponyName.setText(mStoreDetialData.getData().getStore_name());

            tvPrice.setText("¥" + mStoreDetialData.getData().getActivity().getMoney());
            ...
            String ruleContent="抽奖规则：\n活动时间："+mStoreDetialData.getData().getActivity().getBegin_time()+"-"+mStoreDetialData.getData().getActivity().getEnd_time()+
                    "\n1.活动结束后在付款成功个的订单中随机抽取中奖者。\n2.客服会联系中奖者。";

            tvLuckyDrawRule.setText(ruleContent);
    ...
    protected void bindEvent() {
        ...
        tvMoreProduct.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        llyBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(LuckdrawMakeOrderActivity.class,bundle);
        ...
        tvShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mShareListener = new CustomShareListener(LuckdrawDetialActivity.this);
    ...
    protected void bindData() {
        ...
        mPresenter.getChoujiangDetail(String.valueOf(data.getActivity_id()));
    ...
    public void showSuccess(Object object) {
        ...
        dismissLoadDialog();
        if (object instanceof ChoujiangDetialData) {
            mStoreDetialData = (ChoujiangDetialData) object;
            updateView();
...
//                             .into(ivCommentHead);
    ...
    private static class CustomShareListener implements UMShareListener {
        ...
        private WeakReference<LuckdrawDetialActivity> mActivity;

        private CustomShareListener(LuckdrawDetialActivity activity) {
