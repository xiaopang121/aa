...
public class NoReceiveAdapter extends BaseRecyclerAdapter<CollectItemHolder, NoReceiverListData.DataBean> {



    public NoReceiveAdapter(Context context, List<NoReceiverListData.DataBean> list) {
