...
public class ActionFragment4 extends BaseFragment<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    public static ActionFragment4 newInstance() {
        ActionFragment4 mainFragment = new ActionFragment4();
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_action4;
    }
    ...
    protected void bindViewById() {
        ...
        btSumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    ToastUtil.show(getActivity(),"请输入付款金额");
                    return ;
                }
                ...
                mPresenter.createActivity(CacheManager.getInstance().getToken().getData().getUser_id(),
                       ...
                       "",
                        ...
                        "",
                        "",tvExtra.getText().toString(), "","",tvMoney.getText().toString());
