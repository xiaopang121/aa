...
public class OrderPayActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    @Bind(R.id.tv_pay)
    TextView tvPay;
    private UseOrderListData.DataBean.ListBean  dataBean;
    ...
    protected void bindEvent() {
        ...
        tvPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    dismissLoadDialog();
                    requestAlipay(dataBean.getOrder_id());
                }

                if(payType==2)
                {
                    mPresenter.getWxPrePayData(dataBean.getOrder_id(),"","", DeviceUtils.getIpAddressString());
                }
    ...
    protected void bindData() {
        ...
        dataBean =(UseOrderListData.DataBean.ListBean) getIntent().getExtras().getSerializable(ConstantsKeys.KEY_DATA);
        tvShopname.setText(dataBean.getStore_name());
        tvService.setText(dataBean.getService_name());
        tvTotalMoney.setText("￥"+(dataBean.getService_price()));
        tvPay.setText("确认支付：￥"+dataBean.getService_price());
    }
    ...
    private void  requestAlipay(String orderId){
        ...
        Map<String, String> params = OrderInfoUtil2_0.buildOrderParamMap(Constants.APPID,rsa2,Float.valueOf(dataBean.getService_price()),"订单支付",orderId,Constants.NOTIFY_URL,subject);
    ...
    private String getProductArgs(String orderId) {
        ...
        try {
            ...
            int money =(int)(Integer.valueOf(dataBean.getService_price()));
