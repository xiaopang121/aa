...
public class SlideSwitch extends View {
	...
	private static final int DEFAULT_COLOSE_COLOR_THEME = Color.GRAY;
	// 3 attributes
	...
	public SlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		color_theme = a.getColor(R.styleable.slideswitch_openColor,
				DEFAULT_COLOR_THEME);

		color_close = a.getColor(R.styleable.slideswitch_closeColor,DEFAULT_COLOSE_COLOR_THEME);
	...
	protected void onDraw(Canvas canvas) {
		if (shape == SHAPE_RECT) {
			...
			radius = UIUtil.dpToPx(getResources(),20);
			paint.setColor(color_close);
