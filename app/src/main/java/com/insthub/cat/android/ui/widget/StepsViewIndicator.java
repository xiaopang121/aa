...
public class StepsViewIndicator extends View {
    ...
    private int mHideCirclePosition = -1;
    private int mHideEndCirclePosition = -1;
    ...
    public void setHideCircle(int position,int end)
    {
        mHideCirclePosition = position;
        mHideEndCirclePosition = end;
    }
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mThumbContainerXPosition.size(); i++) {
            ...
            if(i<mHideCirclePosition ||i>mHideEndCirclePosition)
            {
            ...
            if (i == mCompletedPosition && i<mHideCirclePosition ||i>mHideEndCirclePosition) {
