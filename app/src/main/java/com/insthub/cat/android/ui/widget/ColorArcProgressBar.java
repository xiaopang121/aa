...
public class ColorArcProgressBar extends View{
    ...
    private int[] colors = new int[]{getContext().getResources().getColor(R.color.theme_color_primary)};
    ...
    private float curSpeedSize = dipToPx(6);
    ...
    private float  circleWidth=dipToPx(8);

    private String hintColor = "#676767";
    private String longDegreeColor = "#dbdbdb";
    private String shortDegreeColor = "#dbdbdb";
    private String bgArcColor = "#dbdbdb";
    ...
    private void initView() {
        ...
        bgRect.bottom =diameter*2;


        //圆心
        centerX = (2 * longdegree + progressWidth + diameter + 2 * DEGREE_PROGRESS_DISTANCE);
        centerY = (2 * longdegree + progressWidth + diameter + 2 * DEGREE_PROGRESS_DISTANCE);
        ...
        cirlePaint.setStrokeCap(Paint.Cap.ROUND);
        cirlePaint.setStrokeWidth(8);
        cirlePaint.setColor(Color.parseColor("#ec623d"));

        //绘制白色小圆点
        cirleWhitePaint = new Paint();
        cirleWhitePaint.setAntiAlias(true);
        cirleWhitePaint.setStyle(Paint.Style.FILL);
        cirleWhitePaint.setStrokeCap(Paint.Cap.ROUND);
        cirleWhitePaint.setColor(Color.WHITE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制小圆点
        Path orbit = new Path();
        orbit.addArc(bgRect, startAngle, currentAngle);
        ...
        canvas.drawCircle(pos[0], pos[1],13,cirlePaint);
        canvas.drawCircle(pos[0], pos[1],6,cirleWhitePaint);
