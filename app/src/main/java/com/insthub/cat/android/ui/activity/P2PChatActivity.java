...
public class P2PChatActivity extends BaseActivity {
    ...
    protected void initfragment() {
        ...
        transaction.replace(R.id.message_fragment_container, fragment).commitAllowingStateLoss();
    }
    @Override
    ...
    private void setTitleInfo() {
        commonTitleBar.setTitle(UserInfoHelper.getUserTitleName(sessionId, SessionTypeEnum.P2P));
    }

    /**
     * 设置小标题
     */
    private void setSubTitleInfo(String  subtitle) {
        commonTitleBar.setTitle(UserInfoHelper.getUserTitleName(sessionId, SessionTypeEnum.P2P));
    }
    ...
    protected void showCommandMessage(CustomNotification message) {
        ...
        try {
            ...
            if (id == 1) {
                // 正在输入
                ToastUtil.show(getContext(),"对方正在输入...");
            } else {
                ToastUtil.show(getContext(),"command: " + content);
            }
