...
public class FileUtil {
    ...
    // 用户头像保存位置
    private final static String HEADPHOTO_PATH = "/";

    // 剪切头像时临时保存头像名字，完成或取消时删除
    public final static String HEADPHOTO_NAME_TEMP = "user_photo_temp.png";
    //拍照临时存取图片
    public final static String HEADPHOTO_NAME_RAW = "user_photo_raw.png";
    ...
    public static String getHeadPhotoDir() {
        ...
        String path = Environment.getExternalStorageDirectory() + HEADPHOTO_PATH;
