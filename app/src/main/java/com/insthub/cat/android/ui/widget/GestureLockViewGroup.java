...
public class GestureLockViewGroup extends RelativeLayout {
    ...
    //四种状态的内圆大小百分比
    private float mNoFingerInnerCircleRate = 0.1f;
    private float mFingerOnInnerCircleRate = 0.1f;
    private float mFingerUpMatchInnerCircleRate = 0.1f;
    private float mFingerUpUnMatchInnerCircleRate = 0.1f;
