...
import com.insthub.cat.android.ui.adatper.LocalImgAdapter2;
...
public class ShopDetialActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View, LocalImgAdapter2.BannerCallback {
    ...
    private  CollectServiceData mCollectStoreData;
...
//        mLBanners.setHoriZontalCustomTransformer(new ParallaxTransformer(R.id.id_image));//自定义样式
        ...
        mLBanners.setAdapter(new LocalImgAdapter2(this, this), bannerList);
        //本地用法
    ...
    private void updateView() {
        ...
        if (mStoreDetialData != null) {
            ...
            mLBanners.setAdapter(new LocalImgAdapter2(getActivity(), this), bannerList);
            ...
            if(mStoreDetialData.getData().getImage_list().size()>0)
            {
                for (int x=0;x<mStoreDetialData.getData().getImage_list().size();x++)
                {
                    ...
                    lp.setMargins(UIUtil.dpToPx(getResources(), 2), UIUtil.dpToPx(getResources(), 2), UIUtil.dpToPx(getResources(), 2), 0);
...
//                            .into(iv);
                    ...
                    ViewGroup.LayoutParams lp2 = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,2);
            ...
            switch (mStoreDetialData.getData().getIs_collect())
            {
                case 0:
    ...
    protected void bindEvent() {
        ...
        tvShopDetial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {


                Bundle bundle = new Bundle();
                data.setStore_id(mStoreDetialData.getData().getStore_id());
        ...
        tvBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bundle bundle = new Bundle();
                bundle.putSerializable(ConstantsKeys.KEY_DATA,mStoreDetialData.getData());
                startActivity(ShopBuyActivity.class,bundle);
        ...
        tvShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mShareListener = new CustomShareListener(ShopDetialActivity.this);
    ...
    protected void bindData() {
        ...
        mPresenter.getStoreDetail(data.getStore_id());
...
//                             .into(ivCommentHead);
        ...
        if(object instanceof CollectServiceData)
        {
            mCollectStoreData = (CollectServiceData)object;
    ...
    private static class CustomShareListener implements UMShareListener {
        ...
        private CustomShareListener(ShopDetialActivity activity) {
