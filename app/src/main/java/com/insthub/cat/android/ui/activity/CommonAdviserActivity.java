...
public class CommonAdviserActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View {
   ...
   private String url;
        ...
        commonTitleBar.ivRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ShareAction mShareAction = new ShareAction(getActivity()).setDisplayList(
                        SHARE_MEDIA.WEIXIN,SHARE_MEDIA.QQ, SHARE_MEDIA.WEIXIN_CIRCLE,SHARE_MEDIA.SINA)
    ...
    protected void bindData() {
        super.bindData();
        url = this.getIntent().getExtras().getString(ConstantsKeys.KEY_JUM_ACTIVITY);

        commonTitleBar.setTitle("广告");
