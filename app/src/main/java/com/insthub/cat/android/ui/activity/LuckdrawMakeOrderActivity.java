...
public class LuckdrawMakeOrderActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    @Bind(R.id.tv_pay)
    TextView tvPay;
    private ChoujiangDetialData dataBean;
    ...
    protected void bindData() {
        ...
        dataBean = (ChoujiangDetialData) getIntent().getExtras().getSerializable(ConstantsKeys.KEY_DATA);

        tvShopname.setText(dataBean.getData().getStore_name());
        tvService.setText(dataBean.getData().getService_content());
        tvTotalMoney.setText("￥"+dataBean.getData().getActivity().getMoney());
        tvPay.setText("确认支付：￥"+dataBean.getData().getActivity().getMoney());
