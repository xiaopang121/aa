...
public class UserFragmentBack extends BaseFragment<MVPPresenter, MVPModel> implements MVPContract.View {
...
//    TextView tvShopManager;
    ...
    public static UserFragmentBack newInstance() {
        UserFragmentBack mainFragment = new UserFragmentBack();
