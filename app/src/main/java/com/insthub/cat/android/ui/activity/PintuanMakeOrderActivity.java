...
public class PintuanMakeOrderActivity extends BaseActivity<MVPPresenter, MVPModel> implements MVPContract.View {
                    ...
                    public void call(PaymentStatus event) {
                        if(event.isStatus())
                        {
                          ...
                          //支付成功后操作
                            ...
                            startActivity(PintuanmoActivity.class,bundle);
