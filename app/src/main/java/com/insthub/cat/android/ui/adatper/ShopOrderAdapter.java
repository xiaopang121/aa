...
public class ShopOrderAdapter extends BaseRecyclerAdapter<ShopOrderItemHolder, ShopOrderListData.DataBean.ListBean> {


    private ShopOrderCallback mShopOrderCallback;


    public ShopOrderAdapter(Context context, List<ShopOrderListData.DataBean.ListBean> list) {
    ...
    public void onBindViewHolder(ShopOrderItemHolder holder, int position) {
        ...
        holder.itemOrderTime.setText("下单时间："+getDataItem(position).getCreate_time());
        ...
        holder.ivChat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mShopOrderCallback!=null)
                {
                    mShopOrderCallback.applayChat(pos);
                }
            }
        });
...
//        holder.tvOrderApplyPay.setTag(position);
//
//        holder.tvOrderApplyPay.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                int pos = (int)view.getTag();
//
//                if(mShopOrderCallback!=null)
//                {
//                    mShopOrderCallback.applyPay(pos);
//                }
//            }
//        });
