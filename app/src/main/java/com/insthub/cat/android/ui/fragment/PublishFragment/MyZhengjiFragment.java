...
import com.insthub.cat.android.ui.adatper.MyTenderListAdapter;
import com.insthub.cat.android.ui.adatper.MyZhengjiListAdapter;
...
public class MyZhengjiFragment extends BaseFragment<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    private MyZhengjiListAdapter mMyZhengjiListAdapter;
    ...
    public static MyZhengjiFragment newInstance() {
        MyZhengjiFragment mainFragment = new MyZhengjiFragment();
    ...
    protected void bindViewById() {
        ...
        mMyZhengjiListAdapter = new MyZhengjiListAdapter(getActivity(), dataList);
        recyclerview.setAdapter(mMyZhengjiListAdapter);
    ...
    protected void bindEvent() {
        ...
        mPullToRefreshRecycle.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<SwipeMenuRecyclerView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<SwipeMenuRecyclerView> pullToRefreshBase) {
                ...
                mPresenter.getInnovateList(page,page_count,0,CacheManager.getInstance().getToken().getData().getUser_id());
            }
    ...
    public void showSuccess(Object object) {
        ...
        mMyZhengjiListAdapter.notifyDataSetChanged();
