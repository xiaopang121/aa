...
import com.insthub.cat.android.ui.activity.TenderDetialActivity;
...
public class MyTenderFragment extends BaseFragment<MVPPresenter, MVPModel> implements MVPContract.View {
    ...
    private MyTenderListAdapter mTenderAdapter;
    ...
    public static MyTenderFragment newInstance() {
        MyTenderFragment mainFragment = new MyTenderFragment();
    ...
    protected void bindViewById() {
        ...
        mTenderAdapter = new MyTenderListAdapter(getActivity(), dataList);
    ...
    protected void bindEvent() {
        ...
        mPullToRefreshRecycle.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<SwipeMenuRecyclerView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<SwipeMenuRecyclerView> pullToRefreshBase) {
                page=1;
                mPresenter.getTenderList(page,page_count,"",CacheManager.getInstance().getToken().getData().getUser_id());
            }
