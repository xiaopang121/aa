...
public class TopRightMenu {
    ...
    private void init() {
        ...
        mRecyclerView.addItemDecoration(new MenuDividerItemDecoration(mContext,MenuDividerItemDecoration.VERTICAL_LIST, true, R.drawable.menu_item_divider_black_1));
