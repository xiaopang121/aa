 ...
 *******************************************************************************/
package com.common.extend.pulltorefresh.internal;
...
import com.common.extend.pulltorefresh.ILoadingLayout;
import com.common.extend.pulltorefresh.PullToRefreshBase;
import com.common.extend.pulltorefresh.PullToRefreshBase.Orientation;
    ...
    public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final Orientation scrollDirection, TypedArray attrs) {
        ...
        switch (mode) {
            ...
            default:
                ...
                mRefreshingLabel = context.getString(R.string.pushmsg_center_load_more_ongoing_text);
