...
class HexEdit {
	...
	private static  TextWatcher mTextWather;

	public static void setUpListeners(final TextView hexEdit, final ObservableColor observableColor) {
		...
		if(textView!=null&&mTextWather!=null)
		{
			textView.removeTextChangedListener(mTextWather);
		...
		mTextWather = multiObserver;
		observableColor.addObserver(multiObserver);
		setShowAlphaDigits(hexEdit, true);
	}


	public static void setShowAlphaDigits(final TextView hexEdit, boolean showAlphaDigits) {
