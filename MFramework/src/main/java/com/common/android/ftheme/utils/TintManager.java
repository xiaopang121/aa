...
package com.common.android.ftheme.utils;
...
import com.common.android.ftheme.drawables.FilterableStateListDrawable;
...
public class TintManager {
    ...
    //过滤器着色   渲染模式
    private static final PorterDuff.Mode DEFAULT_MODE = PorterDuff.Mode.SRC_IN; //只对有像素的地方着色
