package com.common.android.futils.dialogutils;
...
public class PromptDialog extends Dialog {
    ...
    private void initView() {
        ...
        triangleIv.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, UIUtil.dpToPx(getContext().getResources(), 10)));
        triangleIv.setImageBitmap(createTriangel((int) (UIUtil.getScreenSize(getContext()).x * 0.7), UIUtil.dpToPx(getContext().getResources(), 10)));
        ...
        int radius = UIUtil.dpToPx(getContext().getResources(), DEFAULT_RADIUS);
    ...
    private void resizeDialog() {
        ...
        params.width = (int)(UIUtil.getScreenSize(getContext()).x * 0.7);
