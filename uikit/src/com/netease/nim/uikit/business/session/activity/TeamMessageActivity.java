...
import com.netease.nim.uikit.common.ui.widget.CommonTitleBar;
...
public class TeamMessageActivity extends BaseMessageActivity {
    ...
    protected void findViews() {
        ...
        mCommonTitleBar= (CommonTitleBar)findViewById(R.id.common_title_bar);
//        int statubar = ScreenUtil.getStatusBarHeight( this);
//        ViewGroup.LayoutParams lp = mCommonTitleBar.getLayoutParams();
//        lp.height = lp.height + statubar;
//        mCommonTitleBar.setPadding(0, statubar, 0, 0);
//        mCommonTitleBar.setLayoutParams(lp);
//        mCommonTitleBar.invalidate();
        mCommonTitleBar.setLeftImageMenu(R.drawable.ic_back_white_24dp);
        mCommonTitleBar.setTitle("群聊");

        mCommonTitleBar.setRighImageMenu(R.drawable.nim_ic_message_actionbar_team);
    ...
    private  void  bindEvent()
    {
        ...
        mCommonTitleBar.ivLeft.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mCommonTitleBar.ivRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {


                if(customization!=null && customization.buttons.size()>0)
                {
                    customization.buttons.get(0).onClick(TeamMessageActivity.this,v,sessionId);
                }
    ...
    private void setTiamTitle(String title)
    {
    ...
    private void updateTeamInfo(final Team d) {
        ...
        setTiamTitle(team == null ? sessionId : team.getName() + "(" + team.getMemberCount() + "人)");
