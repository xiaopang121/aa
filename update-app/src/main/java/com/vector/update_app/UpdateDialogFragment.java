...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private IgnoreVersionCallback mIgnoreVersionCallback;
    ...
    public interface  IgnoreVersionCallback
    {
...
//        setStyle(DialogFragment.STYLE_NO_TITLE | DialogFragment.STYLE_NO_FRAME, 0);
    ...
    public void setCancleCallback(IgnoreVersionCallback callback)
    {
        this.mIgnoreVersionCallback = callback;
    }
